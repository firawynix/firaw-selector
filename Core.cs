...
static class Amb
{
    ...
    public const string Versao = "1.1.5";
...
static class Idioma
{
    ...
    static Idioma()
    {
        ...
        A("op.fantasma", "Sem moldura: só as linhas flutuando — a janela aparece ao passar o mouse",
                         "No frame: just the rows floating — the window shows up on mouse over");
