...
FirawSelector publishes Windows release artifacts from this public repository.
...
- Source repository: <https://github.com/firawynix/firaw-selector>
- License: [MIT](LICENSE)
...
merge. Changes to build, packaging, browser integration, or signing files
receive the same review as application code.

## Privacy and system changes

Read the [privacy policy](privacy.md). The installer and application describe
their user-visible protocol, file-association, and browser-integration changes,
and the project provides an uninstaller.
